...
// "СмТр" ритмично обрвывает проходящее питание
// создавая уникальный П-образный эффект тремоло
// в строке "темп" можно указывать bpm песни
// в "паттерне" можно создавать ритмический рисунок
